                ...
                <div className="flex-1">
                  ...
                  {paper.file_url ? (
                    <a
                      ...
                      className="inline-flex items-center gap-2 mb-3 px-3 py-1.5 bg-gold-500/10 border border-gold-400/20 text-gold-300 rounded-lg text-xs font-medium hover:bg-gold-500/20 transition-colors"
                    >
                      <FileText className="w-3.5 h-3.5" /> Open uploaded document
                    </a>
                  ) : (
                    <p className="text-white/80 mb-3 line-clamp-3">{paper.content || 'No file uploaded yet.'}</p>
                  )}
            ...
            >
                ...
                <div className="glass-panel p-4 rounded-lg">
                  ...
                  {selectedPaper.file_url ? (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center gap-2 px-4 py-2 bg-gold-500/20 text-gold-300 rounded-lg text-sm font-medium hover:bg-gold-500/30 transition-colors"
                    >
                      <FileText className="w-4 h-4" /> Open uploaded document
                    </a>
                  ) : (
                    <p className="text-white/80 whitespace-pre-wrap">{selectedPaper.content || 'No file uploaded.'}</p>
                  )}
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-2 bg-diplomatic-900 text-white border border-white/20 focus:border-gold-400/50 focus:ring-1 focus:ring-gold-400/50 transition-all rounded-lg"
                    >
                      <option value="pending" className="bg-diplomatic-900 text-white">Pending Review</option>
                      <option value="approved" className="bg-diplomatic-900 text-white">Approved</option>
                      <option value="needs_revision" className="bg-diplomatic-900 text-white">Needs Revision</option>
                    </select>
                  </div>
              ...
              <div className="flex gap-3 mt-6">
                ...
                <button
                  ...
                  title={!reviewFeedback.trim() ? 'Please provide feedback before submitting' : ''}
                >
                  Submit Review
                </button>
              </div>
