        ...
        <section className="relative py-24 md:py-32 overflow-hidden bg-gradient-to-r from-diplomatic-600 to-diplomatic-800">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <motion.div
              ...
              className="mb-12"
            >
              <Link to="/past-conferences" className="inline-flex items-center text-white hover:text-diplomatic-100 transition-colors">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              >
                <motion.div variants={itemVariants} className="mb-16">
                  ...
                  <h3 className="text-3xl md:text-4xl font-bold text-center mb-6 text-gray-800">{seasonData.theme}</h3>

                  <div className="prose prose-lg max-w-none">
                    <p className="text-gray-600 mb-6 text-center">{seasonData.description}</p>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mt-12">
                      <div className="bg-gradient-to-br from-white to-diplomatic-50 p-6 rounded-xl shadow-sm border border-diplomatic-100 hover:shadow-md transition-shadow duration-300">
                        ...
                        <p className="text-gray-600 text-center text-sm">{seasonData.statistics.committees} dynamic committees</p>
                      </div>
                      ...
                      <div className="bg-gradient-to-br from-white to-diplomatic-50 p-6 rounded-xl shadow-sm border border-diplomatic-100 hover:shadow-md transition-shadow duration-300">
                        ...
                        <p className="text-gray-600 text-center text-sm">{seasonData.date}</p>
                      </div>
                      ...
                      <div className="bg-gradient-to-br from-white to-diplomatic-50 p-6 rounded-xl shadow-sm border border-diplomatic-100 hover:shadow-md transition-shadow duration-300">
                        ...
                        <p className="text-gray-600 text-center text-sm">{seasonData.statistics.location}</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
        ...
        <section className="relative py-20 bg-gradient-to-b from-diplomatic-50 to-diplomatic-100">
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold text-diplomatic-800 mb-6">{seasonData.theme}</h2>
                <p className="text-diplomatic-700 leading-relaxed">{seasonData.experience}</p>
              </motion.div>
            </div>
          </div>
        </section>
