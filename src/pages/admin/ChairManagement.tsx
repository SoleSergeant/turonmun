...
const ChairManagement = () => {
  ...
  // Revert any non-pending decision back to pending so the admin can change
                        ...
                        {app.status === 'pending' ? (
                          ...
                          <div className="flex items-center gap-2 flex-wrap">
                            <button
                              ...
                              title="Re-assign to a different committee or role"
                            >
                              <UserCheck className="h-3 w-3" />
                              Reassign
                            </button>
                            <button
                              ...
                              title="Move back to pending and revoke chair access"
                            >
                              Revert
                            </button>
                          </div>
